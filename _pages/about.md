...
## News
* 2026-06: RS has been awarded Sapere Aude: DFF Research Leader grant for the new project [CITADL](https://dff.dk/en/our-funded-projects/meet-the-researchers/research-leaders/eksterne-personer-en/research-leaders-2026/raghavendra-selvan/)
...
* 2026-05: [Wilson et al.](https://arxiv.org/abs/2602.19789), "Position: Stop Preaching and Start Practising Data Frugality for Responsible Development of AI" accepted to be presented at <span style="background-color: #4285F4; color: white; padding: 2px 5px; border-radius: 3px;">ICML</span>, 2026. 
* 2026-04: [Wilson et al.](https://arxiv.org/abs/2602.00056), "How Hyper-Datafication Impacts the Sustainability Costs in Frontier AI" accepted to be presented at <span style="background-color: #4285F4; color: white; padding: 2px 5px; border-radius: 3px;">ACM FAccT</span>, 2026. 
* 2026-04: [Johansen et al.](https://openreview.net/forum?id=LftFQ35l47), "deCIFer: Crystal Structure Prediction from Powder Diffraction Data using Autoregressive Language Models" accepted to <span style="background-color: #4285F4; color: white; padding: 2px 5px; border-radius: 3px;">TMLR</span>.
